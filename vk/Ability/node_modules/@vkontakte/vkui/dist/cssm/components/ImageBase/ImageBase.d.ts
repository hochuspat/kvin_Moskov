...
export declare const ImageBase: {
    ({ alt, crossOrigin, decoding, loading, referrerPolicy, sizes, src, srcSet, useMap, getRef, size, width, height, style, withBorder, fallbackIcon: fallbackIconProp, children, onLoad, onError, ...restProps }: ImageBaseProps): React.JSX.Element;
